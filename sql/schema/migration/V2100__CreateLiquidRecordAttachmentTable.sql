...
-- reordered, only copied onto a claim (see V2110's source_liquid_attachment_id).
--
-- liquid already has ALTER DEFAULT PRIVILEGES from V2060, so this table needs no
-- separate GRANT.
