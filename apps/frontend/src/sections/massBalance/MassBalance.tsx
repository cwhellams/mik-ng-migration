              ...
              <Grid size={{ xs: 12, sm: 2.4 }}>
                ...
                >
                  <CardContent>
                    ...
                    <Typography variant='body2'>
                      (
                      {(results.takeoffWeight * CONVERSIONS.KG_TO_LBS).toFixed(
                        1
                      )}{' '}
                      lbs)
                    </Typography>
              ...
              <Grid size={{ xs: 12, sm: 2.4 }}>
                ...
                >
                  <CardContent>
                    ...
                    <Typography variant='body2'>
                      (
                      {(results.landingWeight * CONVERSIONS.KG_TO_LBS).toFixed(
                        1
                      )}{' '}
                      lbs)
                    </Typography>
              ...
              <Grid size={{ xs: 12, sm: 6 }}>
                <Card sx={{ height: '100%' }}>
                  <CardContent>
                    ...
                    <Typography variant='body2'>
                      ({(totalFuelBurn * CONVERSIONS.LTR_TO_USG).toFixed(1)}{' '}
                      USG)
                    </Typography>
                  </CardContent>
                </Card>
                        ...
                        return (
                          <>
                            ...
                            >
                              ...
                              {(pilot.weight * CONVERSIONS.KG_TO_LBS).toFixed(
                                1
                              )}{' '}
                              lbs)
                            </Typography>
                        ...
                        return (
                          <>
                            <Typography
                              ...
                              sx={{ mb: 1, display: 'block' }}
                            >
                              {t('massBalance.currentLoad')}: {copilot.weight}{' '}
                              kg / {t('massBalance.maxLoad')}: {maxWeight} kg (
                            ...
                            <Slider
                              ...
                              min={
                                selectedAircraft.loadPoints.copilot.minValue!
                              }
                              max={maxWeight}
                              step={
                                selectedAircraft.loadPoints.copilot.step || 1
                              }
                              valueLabelDisplay='auto'
                              sx={{
                                '& .MuiSlider-thumb': {
                            ...
                            return (
                              <>
                                ...
                                <Slider
                                  ...
                                  max={maxWeight}
                                  step={
                                    selectedAircraft.loadPoints.rearSeat.step ||
                                    1
                                  }
                                  valueLabelDisplay='auto'
                                  sx={{
                            ...
                            return (
                              <>
                                ...
                                <Slider
                                  ...
                                  max={maxWeight}
                                  step={
                                    selectedAircraft.loadPoints.rearLeft.step ||
                                    1
                                  }
                                  valueLabelDisplay='auto'
                                  sx={{
                        ...
                        return (
                          <>
                            <Typography
                              ...
                              sx={{ mb: 1, display: 'block' }}
                            >
                              {t('massBalance.currentLoad')}: {baggage.weight}{' '}
                              kg / {t('massBalance.maxLoad')}: {maxWeight} kg (
                            ...
                            <Slider
                              ...
                              min={
                                selectedAircraft.loadPoints.baggage.minValue!
                              }
                              max={maxWeight}
                              step={
                                selectedAircraft.loadPoints.baggage.step || 1
                              }
                              valueLabelDisplay='auto'
                              sx={{
                                '& .MuiSlider-thumb': {
                        ...
                        return (
                          <>
                            ...
                            >
                              ...
                              {maxLitres} L (
                              {(fuel.litres * CONVERSIONS.LTR_TO_USG).toFixed(
                                1
                              )}{' '}
                              USG)
                            </Typography>
